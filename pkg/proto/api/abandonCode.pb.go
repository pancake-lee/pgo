...
var file_abandonCode_proto_rawDesc = []byte{
	...
	0x0d, 0x2f, 0x61, 0x62, 0x61, 0x6e, 0x64, 0x6f, 0x6e, 0x2d, 0x63, 0x6f, 0x64, 0x65, 0x3a, 0x01,
	0x2a, 0x12, 0x6c, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x41, 0x62, 0x61, 0x6e, 0x64, 0x6f, 0x6e, 0x43,
...
func file_abandonCode_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_abandonCode_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DelAbandonCodeByIdx1ListRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
