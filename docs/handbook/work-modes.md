...
- 本项目暂无 `docs/prd.md` 与 `docs/tech.md`，规划模式的上下文读 `README.md` 与 `docs/note.md`；任务落点为 `docs/backlog.md`
- `docs/handbook/eval-guide.md` 暂未建立，评估模式按骨架内联流程执行（代码阅读 + `make` 验证 + 报告写入 `docs/` 对应条目）
- 本项目以库封装和代码生成为主，简单维护类改动可直接在对话中完成并总结到 `docs/note.md`
