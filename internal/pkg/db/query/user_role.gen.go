...
func newUserRole(db *gorm.DB, opts ...gen.DOOption) userRole {
	...
	_userRole.CreateUser = field.NewInt32(tableName, "create_user")
	_userRole.UpdateTime = field.NewTime(tableName, "update_time")
	_userRole.UpdateUser = field.NewInt32(tableName, "update_user")
	_userRole.ProjID = field.NewInt32(tableName, "proj_id")
	_userRole.RoleName = field.NewString(tableName, "role_name")
	_userRole.IsDefault = field.NewInt32(tableName, "is_default")
