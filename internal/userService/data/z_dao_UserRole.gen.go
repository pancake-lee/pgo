...
func (*userRoleDAO) DelByID(ctx *papp.AppCtx, idx1 int32) error {
	if idx1 == 0 {
		return ctx.Log.LogErr(perr.ErrParamInvalid)
	}
	q := db.GetQuery().UserRole
...
func (*userRoleDAO) DelByIDList(ctx *papp.AppCtx, idx1List []int32) error {
	if len(idx1List) == 0 {
		return nil
	}
	q := db.GetQuery().UserRole
...
func (*userRoleDAO) GetByID(ctx *papp.AppCtx, idx1 int32,
...
func (*userRoleDAO) GetByIDList(ctx *papp.AppCtx, idx1List []int32,
