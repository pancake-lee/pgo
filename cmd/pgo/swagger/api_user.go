 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *UserApiUserGetUserPermissionsOpts - Optional Parameters:
     * @param "UserID" (optional.Int32) - 
     * @param "ProjectID" (optional.Int32) - 
@return ApiGetUserPermissionsResponse
*/

type UserApiUserGetUserPermissionsOpts struct {
    UserID optional.Int32
    ProjectID optional.Int32
}

func (a *UserApiService) UserGetUserPermissions(ctx context.Context, localVarOptionals *UserApiUserGetUserPermissionsOpts) (ApiGetUserPermissionsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ApiGetUserPermissionsResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/user/permissions"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ApiGetUserPermissionsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
