...
const file_schoolService_gen_proto_rawDesc = "" +
	"\n" +
	"\x17schoolService.gen.proto\x12\x03api\x1a\x1cgoogle/api/annotations.proto\x1a\fcommon.proto\"\x8f\x03\n" +
...
var (
	...
	file_schoolService_gen_proto_rawDescData []byte
)

func file_schoolService_gen_proto_rawDescGZIP() []byte {
	file_schoolService_gen_proto_rawDescOnce.Do(func() {
		file_schoolService_gen_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_schoolService_gen_proto_rawDesc), len(file_schoolService_gen_proto_rawDesc)))
	})
